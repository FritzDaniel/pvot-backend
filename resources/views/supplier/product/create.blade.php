        ...
        <div class="row">
            ...
            <!-- Default box -->
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form id="updatePassword" class="fpms" action="{{ route('supplier.product.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="productDesc" class="form-control" placeholder="Product Description" value="{{ old('productDesc') }}">
                            </div>
                            <div class="form-group">
                                <label>Product Stock</label>
                                <input type="number" name="productStock" class="form-control" placeholder="Product Quantity" value="{{ old('productStock') }}">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="productCategory">
                                    ...
                                    @foreach($category as $cats)
                                        <option value="{{ $cats->id }}"
                                            {{ old('productCategory') == $cats->id ? 'selected' : '' }}>
                                            {{ $cats->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="productPrice" class="form-control" placeholder="Product Price" value="{{ old('productPrice') }}">
