...
@section('headerTitle')
    Create Design {{ $master->designName }}
@endsection

@section('content')

    <div class="container-fluid">
        <a href="{{ route('admin.subDesign',$master->id) }}" class="btn btn-primary mb-3"><i class="fa fa-angle-left"></i> Back</a>
        <div class="row">
            ...
            <!-- Default box -->
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Create Sub Design</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form id="updatePassword" class="fpms" action="{{ route('admin.subDesign.store',$master->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
