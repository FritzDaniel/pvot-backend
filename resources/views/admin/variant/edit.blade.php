        ...
        <div class="row">
            ...
            <!-- Default box -->
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form id="updatePassword" class="fpms" action="{{ route('admin.variant.update',$data->id) }}" method="post">
                            @csrf
                            <div class="form-group">
                                <label>Variant Type</label>
                                <input type="text" name="variantType" class="form-control" placeholder="Variant Type" value="{{ $data->variantType }}">
                            </div>
                        </form>
                    </div>
