        ...
        <div class="row">
            ...
            <!-- Default box -->
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form id="updatePassword" class="fpms" action="{{ route('admin.category.update',$data->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{ asset($data->logo) }}" alt="" class="mb-3" style="width: 75px; height: 75px;">
