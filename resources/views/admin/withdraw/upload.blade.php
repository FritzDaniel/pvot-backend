...
@section('content')
    ...
    <div class="container-fluid">
        <a href="{{ route('admin.withdraw') }}" class="btn btn-primary mb-3"><i class="fa fa-angle-left"></i> Back</a>
        <div class="row">
            ...
            <!-- Default box -->
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Receipt Transfer</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form id="updatePassword" class="fpms" action="{{ route('admin.withdraw.uploadBukti',$data->uuid) }}" method="post" enctype="multipart/form-data">
                            @csrf
